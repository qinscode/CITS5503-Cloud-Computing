...
Skeleton application to copy local files to S3. Given a root local directory, it walks each level and copies files to the same path on S3.

[Download cloudstorage.py](https://raw.githubusercontent.com/qinscode/CITS5503-Cloud-Computing/main/Labs/src/cloudstorage.py)
