...
Sample application to encrypt and decrypt files using AES (requires `pycrypto`).

[Download fileencrypt.py](https://raw.githubusercontent.com/qinscode/CITS5503-Cloud-Computing/main/Labs/src/fileencrypt.py)
