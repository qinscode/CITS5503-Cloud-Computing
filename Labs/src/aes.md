...
Sample program to illustrate the use of `pycrypto` (`pip install pycrypto`). Needs to be modified to (1) read a file in and write out the encrypted contents, and (2) take an encrypted file and write out the plaintext version.

[Download aes.py](https://raw.githubusercontent.com/qinscode/CITS5503-Cloud-Computing/main/Labs/src/aes.py)
